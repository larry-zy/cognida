...
### Requirement: ToolRegistry in application layer
**Reason**: Tool management is a domain concern, should be defined in Domain layer
**Migration**: Use `domain.ToolRegistry` interface from `domain/agent/service.go`

### Requirement: ToolExecutor in application layer
**Reason**: Tool execution is a domain service, should be defined in Domain layer
**Migration**: Use `domain.ToolExecutor` interface from `domain/agent/service.go`
