...
- **link-python**：`services/evaluation/graders/builtin/llm.py`、`services/evaluation/runner.py`、`services/evaluation/service.py`、`services/evaluation/metrics/llm_judge.py`。
- **link-web**：`src/utils/request.ts`、`src/stores/auth.ts`、`src/api/agent/index.ts`、`src/api/chat/stream.ts`、`src/utils/sse.ts`。
