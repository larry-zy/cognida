...
- [x] 0.4 运行 `cd link-go && go build ./...`、`cd link-python && pytest -q` 记录基线
...
- [x] 1.6.1 `cd link-go && go build ./...`
- [x] 1.6.2 `cd link-go && go test ./internal/handler/... ./internal/service/knowledge/... -v`
...
- [x] 2.4.1 `cd link-python && pytest tests/ -v`（评测相关用例）
...
- [x] 3.7.1 `cd link-go && go build ./...`
- [x] 3.7.2 `cd link-go && go test -race ./internal/service/agent/... -v`
...
- [x] 4.1.3 如新增列/表，跑 `cd link-go && set -a && source .env && set +a && go run ./cmd/migrate-db` 同步
...
- [x] 4.3.1 `cd link-go && go build ./...`
- [x] 4.3.2 `cd link-go && go test ./internal/service/chat/... ./internal/service/agent/... -v`
...
- [x] 6.2 `cd link-go && go build ./... && go test ./... && go vet ./...`
- [x] 6.3 `cd link-python && pytest tests/ -v`
