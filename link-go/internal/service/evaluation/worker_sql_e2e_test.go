...
//
//	LINK_EVAL_E2E_ENDPOINT=http://127.0.0.1:18888 \
//	DB_HOST=localhost DB_PORT=3306 DB_USER=root DB_PASSWORD=... DB_NAME=link \
...
func TestE2E_SQLComputeMetrics_RealDB_Live(t *testing.T) {
	...
	if out := os.Getenv("LINK_EVAL_E2E_OUTPUT"); out != "" {
		payload := map[string]any{
			...
			"endpoint":     endpoint,
			"dsn_db":       sqlE2EEnvOr("DB_NAME", "link"),
